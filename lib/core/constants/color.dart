...
class AppColors {
  ...
  /// main widget color orange
  static const Color primaryElement = Color.fromARGB(255, 238, 121, 0);
  ...
  static const Color primaryElementBg = Color.fromARGB(255, 61, 61, 216);
}
